...
b) Muitos defeitos encontrados só depois da entrega (implementaçao)
c)Código sem padrão e difícil de evoluir (projeto)
d)Correções urgentes em produção consumindo o tempo do time (testes e manutenção)

3.a) modelo iterativo incremental, pois a empresa já está com o projeto em andamento, e esse processo vai ajustar o que já foi feito e ajudar em novas incrementações.
b)De não ser eficiente 
